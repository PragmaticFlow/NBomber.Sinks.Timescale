...
public class TimescaleDBReportingExample
{
    ...
    public void Run()
    {
        ...
        const string connectionString = "Host=localhost;Port=5432;Database=metricsdb;Username=timescaledb;Password=timescaledb;Pooling=true;Maximum Pool Size=3000;";
