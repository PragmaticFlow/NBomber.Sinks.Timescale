...
static class ColumnNames
{
    ...
    public const string NodeCpuCount = "node_cpu_count";
    public const string Scenario = "scenario";
    public const string LessOrEq800 = "less_or_eq_800";
    public const string More800Less1200 = "more_800_less_1200";
    public const string MoreOrEq1200 = "more_or_eq_1200";
